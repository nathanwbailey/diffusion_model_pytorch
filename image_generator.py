...
class ImageGenerator():
    ...
    def __init__(self, num_img: int, num_diffusion_steps: int, diffusion_model: DiffusionModel) -> None:
        """Init Variables."""
    ...
    def on_epoch_end(self, epoch: int) -> None:
        ...
        generated_images = self.diffusion_model.generate_images(self.num_img, self.num_diffusion_steps).detach().cpu()
